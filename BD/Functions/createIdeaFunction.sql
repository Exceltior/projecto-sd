...
CREATE OR REPLACE FUNCTION createIdea (titulo IN Varchar2, descricao IN Varchar2, user_id IN NUMBER, preco IN Number) RETURN NUMBER IS  
...
BEGIN
  ...
  UPDATE Utilizador set dinheiro = dinheiro - preco where userid = user_id;  
