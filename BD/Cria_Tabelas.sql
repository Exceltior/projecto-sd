...
CREATE TABLE Ideia
  (
    ...
    descricao VARCHAR2 (10000) NOT NULL ,
...
CREATE TABLE IdeiaFicheiro
  (
    iid          NUMBER (7) NOT NULL ,
    path         VARCHAR2 (70) NOT NULL ,
    originalfile VARCHAR2 (100) NOT NULL
  ) ;
ALTER TABLE IdeiaFicheiro ADD CONSTRAINT IdeiaFicheiro_PK PRIMARY KEY
(
  iid, path
)
;
...
CREATE TABLE "Share"
  (
    iid       NUMBER (7) NOT NULL ,
    userid    NUMBER (7) NOT NULL ,
    numshares NUMBER (5) NOT NULL ,
    valor     NUMBER (10) NOT NULL ,
    nummin    NUMBER (5) NOT NULL
  ) ;
ALTER TABLE "Share" ADD CONSTRAINT Share_PK PRIMARY KEY
(
  iid, userid, valor, numshares, nummin
)
;
...
ALTER TABLE IdeiaFicheiro ADD CONSTRAINT IdeiaFicheiro_Ideia_FK FOREIGN KEY ( iid ) REFERENCES Ideia ( iid ) ;
