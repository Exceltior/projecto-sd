...
/*Criacao das Ideias:*/
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Joao Sousa', 'A descida do Joao Sousa no ranking ATP nao desvaloriza o trabalho que ele tem vindo a realizar este ano',1,1,null,null,100);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Academica', 'A Academica vai revalidar o titulo da taça, que ganhou em 1939 e 2012',1,1,null,null,10);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Cortejo Latada', 'O Cortejo da Latada e um excelente evento',1,1,null,null,2);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Atletas Portugueses', 'Se o Joao Sousa fosse bom ja tinha chamado a atencao no ranking ATP a muito tempo. A sua descida nao e nada mais do que um processo descendente normal na sua carreira',2,1,null,null,5);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Tenis Portugal', 'O Joao Sousa tem feito um trabalho notavel. O facto de ter conseguido entrar em todos os torneios do Grand Slam esta temporada mostra uma melhoria significativa e um excelente salto para a sua carreira tenistica',1,1,null,null,4);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Futebol Clube do Porto', 'O Futebol Clube do Porto vai ser o próximo campeão nacional',1,1,null,null,90);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Benfica', 'O Benfica este ano tem uma equipa muito mais equilibrada e competitiva do que o Porto!',2,1,null,null,50);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Festa das Latas', 'O Cortejo da Festa das Latas este ano teve uma menor adesao do que o esperado devido a chuva',2,1,null,null,11);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Gastao Elias', 'O Gastao Elias e bem capaz de ter muito mais potencial do que o Frederico Gil ou o Joao Sousa. Poderia perfeitamente ser o melhor tenista Portugues da actualidade e de sempre',3,1,null,null,13);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Mario Jardel', 'Sempre gostei de ver jogadores como Mario Jardel a jogar a bola. Gostava que ele ainda jogasse, e de preferencia no Porto',2,1,null,null,16);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Super Mario', 'O Mario Jardel foi de facto um jogador estupendo, quer no Porto, quer no Sporting',1,1,null,null,14);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Taca de Portugal', 'A Taca de Portugal este ano vai ser entregue ao Benfica, que perdeu o ano passado para o Guimaraes',2,1,null,null,10);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Cartaz Latada','O Cartaz da Festa das Latas deste ano estava bem preenchido. Sempre com bons convidados em todos os dias',4,1,null,null,11);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Latada Coimbra', 'Eu por acaso discordo dessa opinao de que o cartaz da Latada estava bom. Nao gostei dos artistas convidados este ano',1,1,null,null,13);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Queima das Fitas', 'Eu regra geral frequento as noites do parque na Latada e na Queima, ms este ano nao tive oportunidade de aparecer no recinto da Latada. Espero ter mais disponibilidade para o fazer na Queima das Fitas',5,1,null,null,16);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Queima','User 5, se me permite uma questao: Porque e que nao teve disponibilidade? Muito trabalho na faculdade? Se essa for a razao, compreendo perfeitamente',3,1,null,null,15);
INSERT INTO Ideia VALUES (idea_seq.nextval, 'Resposta User 3','Sim, foi exactamente por ter trabalho na faculdade. Mas quanto a isso nao ha nada a fazer, temos que trabalhar e cara alegre :P',5,1,null,null,17);
